 ...
 * navItems.tsx
 *
 * Single source of truth for all user navigation items.
 * Imported by BottomDock — never duplicated elsewhere.
 * Add, remove, or reorder items here and every consumer updates automatically.
 */
...
export interface NavItem {
  ...
  label: string;
  path:  string;
  /** Per-item accent glow colour used by BottomDock hover magnification. */
  color: string;
  icon:  ReactNode;
}
...
// ── Icon map (exported for consumers that need individual icons) ─
